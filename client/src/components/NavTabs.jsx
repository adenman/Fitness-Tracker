          ...
          {Auth.loggedIn() ? (
            <div className="py-4 overflow-y-auto">
              <ul className="space-y-2 font-medium">
                <li>
                <button onClick={() => navigate('/')} className="flex items-center p-2 text-white rounded-lg group">
                ...
                <li>
                  <button onClick={()=> navigate(`/profile/${id}`)} className="flex items-center p-2 text-white rounded-lg group">
                ...
                <li>
                  <button onClick={() => Auth.logout()} className="flex items-center p-2 text-white rounded-lg group">
